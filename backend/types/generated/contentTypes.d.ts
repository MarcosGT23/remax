...
export interface ApiAgenteAgente extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Colecci\u00F3n de agentes inmobiliarios con redes sociales, especialidad, biograf\u00EDa y propiedades a cargo';
    displayName: 'Agente';
    pluralName: 'agentes';
    singularName: 'agente';
  };
  ...
  attributes: {
    ...
    city: Schema.Attribute.Enumeration<['Santa Cruz', 'La Paz', 'Cochabamba']>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    email: Schema.Attribute.Email;
    ...
    propertiesCount: Schema.Attribute.Integer;
    propiedades: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiNoticiaNoticia extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Noticias y publicaciones de blog';
    displayName: 'Noticia';
    pluralName: 'noticias';
...
export interface ApiPropiedadPropiedad extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Colecci\u00F3n de inmuebles RE/MAX';
  ...
  attributes: {
    ...
    agent: Schema.Attribute.Relation<'manyToOne', 'api::agente.agente'>;
    amenities: Schema.Attribute.JSON;
    badgeClass: Schema.Attribute.String;
    badgeTitle: Schema.Attribute.Enumeration<
    ...
    publishedAt: Schema.Attribute.DateTime;
    shortId: Schema.Attribute.String & Schema.Attribute.Required;
